...
from image_data_loader import ImageDataPretrain, ImageSeqData, ImageAndPriorSeqData
import time
...
def finetune_resnet50_dilated8_ppm_bilinear(root_dir, list_file_path):
    ...
    model = load_part_of_model_LSTM(model, param['pretrained_model'])
